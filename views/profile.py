...
class ProfileView:
    ...
    def setup_profile_frame(self):
        ...
        tk.Label(details_frame, textvariable=self.name_var, font=("Helvetica", 14), fg="blue").grid(row=0, column=1, sticky='w')

        tk.Label(details_frame, text="Email:", font=("Helvetica", 14)).grid(row=2, column=0, sticky='w')
        tk.Label(details_frame, textvariable=self.email_var, font=("Helvetica", 14), fg="blue").grid(row=2, column=1, sticky='w')

        tk.Label(details_frame, text="Active:", font=("Helvetica", 14)).grid(row=4, column=0, sticky='w')
        tk.Label(details_frame, textvariable=self.active_var, font=("Helvetica", 14), fg="blue").grid(row=4, column=1, sticky='w')

        tk.Label(details_frame, text="Role:", font=("Helvetica", 14)).grid(row=6, column=0, sticky='w')
        tk.Label(details_frame, textvariable=self.role_var, font=("Helvetica", 14), fg="blue").grid(row=6, column=1, sticky='w')
